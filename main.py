...
#        client.loop_start()
        ...
        for x in HOSTs:
          ...
          client.publish("homeassistant/sensor/miner" + str(num) + "/hash_5s/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner' + str(num) + '"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner' + str(num) + '"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner' + str(num) + '","name":"Miner' + str(num) + ' HASH_5s","state_class":"measurement","state_topic":"antminer/miner' + str(num) + '","unique_id":"miner' + str(num) + '_hash_5s","unit_of_measurement":"TH","value_template":"{{ (value_json.STATS.1[\'GHS 5s\'] / 1000) | round(1) }}"}', 1)
          client.publish("homeassistant/sensor/miner" + str(num) + "/hash_30m/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner' + str(num) + '"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner' + str(num) + '"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner' + str(num) + '","name":"Miner' + str(num) + ' HASH_30m","state_class":"measurement","state_topic":"antminer/miner' + str(num) + '","unique_id":"miner' + str(num) + '_hash_30m","unit_of_measurement":"TH","value_template":"{{ (value_json.STATS.1.rate_30m / 1000) | round(1) }}"}', 1)
