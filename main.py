...
#        client.loop_start()
        ...
        client.publish("homeassistant/sensor/miner1/temperature1/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"temperature","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 temp1","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_temperature1","unit_of_measurement":"°C","value_template":"{{ value_json.STATS.1.temp1 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/temperature2/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"temperature","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 temp2","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_temperature2","unit_of_measurement":"°C","value_template":"{{ value_json.STATS.1.temp2 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/temperature3/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"temperature","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 temp3","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_temperature3","unit_of_measurement":"°C","value_template":"{{ value_json.STATS.1.temp3 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/fan1/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 FAN1","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_fan1","unit_of_measurement":"rpm","value_template":"{{ value_json.STATS.1.fan1 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/fan2/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 FAN2","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_fan2","unit_of_measurement":"rpm","value_template":"{{ value_json.STATS.1.fan2 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/fan3/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 FAN3","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_fan3","unit_of_measurement":"rpm","value_template":"{{ value_json.STATS.1.fan3 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/fan4/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 FAN4","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_fan4","unit_of_measurement":"rpm","value_template":"{{ value_json.STATS.1.fan4 }}"}', 1)
        client.publish("homeassistant/sensor/miner1/hash/config", '{"availability":[{"topic":"antminer/status"}],"device":{"identifiers":["antminer_to_mqtt_miner1"],"manufacturer":"Antminer","model":"S19j pro","name":"Miner1"},"device_class":"speed","enabled_by_default":true,"json_attributes_topic":"antminer/miner1","name":"Miner1 HASH","state_class":"measurement","state_topic":"antminer/miner1","unique_id":"miner1_hash","unit_of_measurement":"TH","value_template":"{{ (value_json.STATS.1[\'GHS 5s\'] / 1000) | round(1) }}"}', 1)
